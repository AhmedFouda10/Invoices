...
@section('title')
{{ trans('main_trans.الفواتير المدفوعة جزئيا') }}
@endsection
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('main_trans.الفواتير') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{ trans('main_trans.الفواتير المدفوعة جزئيا') }} </span>
						</div>
					</div>
												...
												<td>
													<div class="dropdown">
                                                        ...
                                                        <a href="{{ url('edit_invoices/' . $invoice->id) }}"
                                                            ...
                                                            {{ trans('main_trans.تعديل الفاتورة') }}
                                                        </a>
                                                    @endcan
...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">أرشفه الفاتورة</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			</button>
