...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معاينه طباعه فاتوره</span>
						</div>
					</div>
							...
							<div class="card card-invoice">
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											<label class="tx-gray-600">الفاتورة معلومات</label>
									...
									<div class="table-responsive mg-t-40">
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
                                                ...
                                                <tr>
													<td class="tx-right"> الاجمالي شامل الضريبه</td>
