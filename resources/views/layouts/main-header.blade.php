				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" placeholder="Search for anything..." type="search" id="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a style="color: #fff" href="{{url('mark/read/all')}}">تعين قراءة الكل</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات المقروءة :</p>
										<h6 style="color: yellow" id="notifications_count">{{Auth::user()->unreadNotifications()->count()}}</h6>
									</div>
									<div id="unreadNotifications">
										@foreach (Auth()->user()->unreadNotifications as $noification)									

										<div class="main-notification-list Notification-scroll" >
											<a class="d-flex p-3 border-bottom" href="{{url('invoices_details')}}/{{$noification->data['id'] }}">
												...
												<div class="mr-3">
													...
													<h5 class="notification-label mb-1">
														{{$noification->data['title']}} {{$noification->data['user']}} 
													</h5>
													<div class="notification-subtext">
														{{$noification->created_at}}
													</div>
							...
							@endcan
							<div class="dropdown nav-item main-header-notification">
								<a class="new nav-link" href="#" style="padding:0px">
									<i class="fas fa-globe"></i>
									<div class="dropdown-menu" style="width:0px;min-width:120px">
							<ul style="padding: 0;text-align: center; margin-bottom:0px">
								@foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
									<li style="list-style: none;font-size: 1.1rem;font-weight: bold; color: rgba(0,0,0,.7); padding: 0.5rem 0px;">
										<a style="font-size: 1.1rem;font-weight: bold; color: rgba(0,0,0,.7);" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
											{{ $properties['native'] }}
										</a>
									</li>
								@endforeach
